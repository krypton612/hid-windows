                        ...
                        if ((arguments[6].length()==0) || (arguments[5].length()==0)) {
                            ...
                            switch (opc) {
                                ...
                                case 2:
                                    ...
                                    if (serverCurses()==88) {
                                        metasploitHandler();
                                        system("su -c \"am start -n com.realvnc.viewer.android/com.realvnc.viewer.android.app.ConnectionChooserActivity > /dev/null 2>&1\"");
                                        info();
                                        ServerDestroy(1);
...
void metasploitHandler(){
    system("vncserver :1 -geometry 550x650 > /dev/null 2>&1 &");
}
void setHid(){
...
void ServerDestroy(int l){
    system("pkill ngrok > /dev/null 2>&1");
    system("pkill php > /dev/null 2>&1");
    if(l==0){
...
void info(){
    system("clear && neofetch --config ../tmp/config.conf --ascii_distro windows7");	
}
